...
! function(t) {
    ...
    function C(t, e) {
        var n = arguments
            ...
            f = Object.keys(t
                .iconUploads || {}).length > 0;
        t.autoA11y.enabled && n(
            i);
        var s = [{
            id: "fa-main",
            addOn: void 0
